...
#输入语料库
train_corpus = "/ssd2/wangzd/code/CoQA_text.txt"

#模型输出
save_model_name = 'CoQA_en_doc2vec.model'
saved_path = "/ssd2/wangzd/code/Bert4CoQA/comparation_query_context/model/CoQA_en_doc2vecModel.bin"
...
model = gm.Doc2Vec(docs, size=vector_size, window=window_size, min_count=min_count, sample=sampling_threshold, workers=worker_count,\
                   hs=0, dm=dm, negative=negative_size, dbow_words=1, dm_concat=1, pretrained_emb=None, iter=train_epoch)
